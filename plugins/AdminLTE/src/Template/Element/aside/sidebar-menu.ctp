...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/skills/index'); ?>"><i class="fa fa-search"></i> View</a></li>
            <li><a href="<?php echo $this->Url->build('/skills/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
        </ul>
    </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/clubs/index'); ?>"><i class="fa fa-search"></i> View</a></li>
            <li><a href="<?php echo $this->Url->build('/clubs/add'); ?>"><i class="fa fa-plus"></i> Add</a></li>
        </ul>
    </li>
